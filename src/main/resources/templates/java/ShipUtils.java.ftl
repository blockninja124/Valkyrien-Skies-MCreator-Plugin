...
public class ShipUtils {
    public static List<Ship> getAllLoadedShips(ServerLevel level){
    ...
    private static BlockPos justAssembled;
     ...
     * @return The ship that was created, or null if it wasn't created
     */
    public static ServerShip assembleBlock(ServerLevel level, BlockPos blockPos, double scale) {
    ...
    public static ServerShip assembleBlock(ServerLevel level, BlockPos blockPos) {
        return assembleBlock(level, blockPos, 1.0);
    }
}